    ...
    <div
      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        <div className="flex justify-center">
          <a
            ...
            href="https://simplifyerc.com/">
            {t("erc314")}
            <span className="flex items-center gap-x-1">
          <span className="border-s border-gray-200 text-blue-600 ps-2 dark:text-blue-500">{t("browse")}</span>
          <FiChevronRight className={'text-blue-600 dark:text-blue-500'}/>
        </span>
          </a>
        </div>
        ...
        <div className="mt-5 max-w-xl text-center mx-auto">
          <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
            {t("use")} <span
            className={'bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent'}>LongSwap</span> {t("trading")}
          </h1>
        </div>
        ...
        <div className="mt-8 gap-3 flex justify-center">
          ...
          <Link
            className="inline-flex justify-center items-center gap-x-3 text-center border bg-white text-foreground text-sm font-medium rounded-full focus:outline-none py-3 px-4"
            href="/markets">
            {t("check_market")}
          </Link>
        </div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mt-12">
        ...
        <div className="flex justify-center gap-x-6 sm:gap-x-12 lg:gap-x-24">
          <svg className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto sm:mx-0 text-gray-500"
          ...
          <svg className="py-3 lg:py-5 w-16 h-auto md:w-20 lg:w-24 mx-auto sm:mx-0 text-gray-500" fill="none"
